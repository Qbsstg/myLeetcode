...
public class Solution2104 {
    ...
    public static void main(String[] args) {
        ...
        int[] a1 = new int[]{1, 3, 3};
        int[] a2 = new int[]{4, -2, -3, 4, 1};
        int[] a3 = new int[]{-31372, 86677, 70463, 37727, -91683, -41347, -90576, -82174, -84198,
        ...
        System.out.println(subArrayRanges(a2));
    ...
    public static long subArrayRanges(int[] nums) {
        ...
        Arrays.sort(nums);
        List<Integer> collect1 = Arrays.stream(nums).boxed().collect(Collectors.toList());
        int total = 0;
        int size = collect1.size();
        for (int i = 0; i < size; i++) {
            int a = collect1.get(i);
            for (int j = i + 1; j < size; j++) {
                int b = collect1.get(j);
                total = total + (b - a);
            }
        }
